...
const LeaderboardPage = () => {
    ...
    const podiumData = [
        { rank: "🥇", username: "Mihu Mahi", earnedPoints: 2000, totalPoints: 100000, avatarUrl: avatar1 },
        { rank: "🥈", username: "John Doe", earnedPoints: 1800, totalPoints: 95000, avatarUrl: avatar2 },
        { rank: "🥉", username: "Jane Smith", earnedPoints: 1500, totalPoints: 90000, avatarUrl: avatar3 },
    ];
                    ...
                    <table className="table-auto w-full text-center">
                        ...
                        <tbody>
                            {rankingData.map((user, index) => (
                                ...
                                <tr key={user.rank} className={`bg-${index % 2 === 0 ? "blue-800" : "blue-900"}`}>
